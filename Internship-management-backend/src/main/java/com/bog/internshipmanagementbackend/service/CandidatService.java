...
public interface CandidatService {
    ...
    CandidatDto findCandidatById(int id);
    CandidatDto findByEmailAndNumPerso(String email, String numPerso);
    List<CandidatDto> findAllCandidats();
    CandidatDto updateCandidat(CandidatDto CandidatDto, int id) throws EntityNotFoundException;
    void deleteCandidat(int id);
    void deleteAllCandidats();
    CandidatDto CandidatLogin(String email, String password);
}
